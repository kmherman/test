...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["cluster_lengths@1.npy",new URL("./files/b9893df17034390e255a11f1e63cf091f270b6f724457e2fe40be2d659640a18148932f9e7cd5a3cd51e31cdd10a156371777b31706a6835e83afefb2b0de3f4",import.meta.url)],["nd4js-1.3.0",new URL("./files/7ca5559ad25ab9f271425173d4cae3f6869c61fd95c372abf98e3868ae762c7bb2d2244377f035582bb5ce3285699e168b304a4717b4f24af3e2be93f4bfa791",import.meta.url)]]);
...
Array.from(wc_xyz_1.data).concat(Array.from(wc_xyz_2.data))
)});
  main.variable(observer("cluster_indices")).define("cluster_indices", ["FileAttachment","npyjs"], function(FileAttachment,npyjs){return(
FileAttachment("cluster_lengths@1.npy").arrayBuffer().then(d => new npyjs().parse(d))
)});
...
d3.scaleSequential(y.get(color_select).domain(), t => d3.interpolateRdYlBu(1-t))
  ...
  main.variable(observer("nd")).define("nd", ["require","FileAttachment"], async function(require,FileAttachment){return(
require(await FileAttachment("nd4js-1.3.0").url())
)});
